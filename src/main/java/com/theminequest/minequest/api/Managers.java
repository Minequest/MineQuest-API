...
import com.theminequest.minequest.api.quest.parser.ParserManager;
...
public class Managers {
	...
	public static void setParserManager(ParserManager parserManager) {
		Managers.parserManager = parserManager;
	}
